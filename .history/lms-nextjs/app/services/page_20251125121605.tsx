...
//               <div className="zq390 lynk2 m233p nwdq3 md:max-w-sm">
//                 <div className="nqxya njdg2">
//                   <img
//                     src="https://cdn.flyonui.com/fy-assets/blocks/marketing-ui/about/about-6.png"
//                     alt="stats"
//                     className="rounded-box h-50 c7ys3"
//                   />

//                   <h5 className="iqv7o flex items-center sly4q bk5oo md:flex-wrap">
//                     <span className="icon-[tabler--circle-check] text-base-content size-6 shrink-0"></span>
//                     Quick Summaries
//                   </h5>

//                   <p>
//                     offers concise summaries of over 6,500 nonfiction books,
//                     each designed to be read or listened to in about 15 minutes
//                   </p>
//                 </div>
//               </div>
...
//                 <div className="nqxya njdg2">
//                   <img
//                     src="https://cdn.flyonui.com/fy-assets/blocks/marketing-ui/about/about-7.png"
//                     alt="stats"
//                     className="rounded-box h-50 c7ys3"
//                   />

//                   <h5 className="iqv7o flex items-center sly4q bk5oo md:flex-wrap">
//                     <span className="icon-[tabler--credit-card] text-base-content size-6 shrink-0"></span>
//                     Request Payments
//                   </h5>

//                   <p>
//                     Online tool that summarizes texts such as articles,
//                     scientific papers, and books. It identifies key ideas and
//                     facts
//                   </p>
//                 </div>
//               </div>
...
//                 <div className="nqxya njdg2">
//                   <img
//                     src="https://cdn.flyonui.com/fy-assets/blocks/marketing-ui/about/about-8.png"
//                     alt="stats"
//                     className="rounded-box h-50 c7ys3"
//                   />

//                   <h5 className="iqv7o flex items-center sly4q bk5oo md:flex-wrap">
//                     <span className="icon-[tabler--wallet] text-base-content size-6 shrink-0"></span>
//                     Manage your wallets
//                   </h5>

//                   <p>
//                     Provides summaries of popular nonfiction books, focusing on
...
//             <div className="dpzny k6gdi md:grid-cols-2 lg:grid-cols-3">
//               {/* Existing static cards kept below */}
//               <div className="zq390 lynk2 m233p nwdq3 md:max-w-sm">
//                 <div className="nqxya njdg2">
//                   <img
//                     src="https://cdn.flyonui.com/fy-assets/blocks/marketing-ui/about/about-6.png"
...
//                         <h4 className="font-semibold text-lg"><span className="icon-[tabler--circle-check] text-base-content size-2 shrink-"></span> Course: {course.title}</h4>
//                         <span
//                           className={`badge ${
...
//                         <button className="btn btn-sm btn-outline">Enroll</button>
//                       </div>
//                     </div>
//                     </div>
//                   </div>
